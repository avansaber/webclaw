...
**Note:** The ClawHub package is a lightweight metadata package (SKILL.md + scripts). The full application (API server, Next.js frontend, templates) is automatically cloned from GitHub during post-install. This requires git and internet access on the target server.
