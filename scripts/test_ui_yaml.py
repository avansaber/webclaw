...
ACTION_SKILL_MAP = {
    ...
    "list-budgets": "erpclaw",
    "list-gl-entries": "erpclaw",
    "list-items": "erpclaw",
    "list-warehouses": "erpclaw",
    "list-item-groups": "erpclaw",
    "list-batches": "erpclaw",
    "list-serial-numbers": "erpclaw",
    "list-stock-entries": "erpclaw",
    "list-customers": "erpclaw",
    "list-quotations": "erpclaw",
    "list-sales-orders": "erpclaw",
    "list-delivery-notes": "erpclaw",
    "list-sales-invoices": "erpclaw",
    "list-sales-partners": "erpclaw",
    "list-recurring-templates": "erpclaw",
    "list-suppliers": "erpclaw",
    "list-rfqs": "erpclaw",
    "list-supplier-quotations": "erpclaw",
...
ENTITY_LESS_SKILLS = {"erpclaw", "erpclaw-growth"}  # reports and analytics are entity-less
